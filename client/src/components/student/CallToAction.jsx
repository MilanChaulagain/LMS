...
const CallToAction = () => {
  return (
    <div className='flex flex-col items-center gap-4 pt-10 pb-24 px-8 md:px-0'>
      ...
      <p className='text-gray-500 sm:text-sm'>Lorem, ipsum dolor sit amet consectetur adipisicing elit. Nisi iure libero quae <br />repudiandae tenetur dolore cupiditate asperiores, cum molestiae temporibus?</p>
